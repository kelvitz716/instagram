...
async def mock_session_manager():
    with patch('src.services.instagram_downloader.InstagramSessionManager') as mock:
        ...
        # Mock async methods
        instance._test_session.return_value = (True, "Session is valid")
        instance._test_session.__call__ = AsyncMock(return_value=(True, "Session is valid"))
        instance.get_cookies.return_value = {'sessionid': 'test_session'}
        instance._validate_cookies.return_value = True
        yield instance
