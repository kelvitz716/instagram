...
class RetryableOperation:
    ...
    def __call__(self, func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            for attempt in range(self.max_retries):
                try:
                    ...
                    if attempt == self.max_retries - 1:
                            # Raise the original exception on final attempt for clearer
                            # error messages in tests and callers
            ...
            # If we somehow exit the loop without raising, re-raise last exception
            raise last_exception
